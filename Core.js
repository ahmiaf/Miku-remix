...
reply(`
Please try not to tag him!
He's in not in mood to use keyboard ${reason ? 'With reason ' + reason : 'No reason'}
...
if (AntiLink) {
    ...
    Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} You have been removed for sending link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
    } else {
    }
    }
...
if (antiVirtex) {
    ...
    if (AntiLink) {
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} You have been removed for sending Yt video link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} You have been removed for sending Yt channel link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} You have been removed for sending Instagram link in this group! No promotion is allowed!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} You have been removed for sending Facebook link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} You have been removed for sending Telegram link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} You have been removed for sending Tiktok link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} You have been removed for sending Twitter link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} You have been removed for sending links in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
...
await sleep(500)
m.copyNForward(m.chat, true, { readViewOnce: true }).catch(_ => reply(`May be it has been opened by a bot`))
}
...
const ftroli = {
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    Konichiwa ${pushname} dear 👋. I am ${global.BotName}, a bot developed by: Ahmi to take your WhatsApp usage into next level.
    ...
    ©️ *${global.BotName}* All Rights Reserved by: *Ahmi*
    `
...
//Some special chat replies
 ...
 let smallinput = budy.toLowerCase()
    ...
    if( smallinput.includes('asslam o alikum') || smallinput.includes('aoa') || smallinput.includes('aoa miku')){
      reply (`Walikum Asslam *${pushname}*, \nI am *${BotName}*. How can i help you?`);
    }
   
    if (smallinput=='bot') {
      reply (`Asslam o alikum *${pushname}*, \nI am *${BotName}*, a WhatsApp bot made by *Ahmi* and currently being hosted by *${OwnerName}*. \nType  *${prefix}help* to get my full command list.`);
    }
    ...
    if (smallinput.includes('good morning')) {
      reply (`Good morning to you too *${pushname}* ☺️.\nHave a great day 😇.`);
    }
    ...
    if (smallinput.includes('thanks Miku') || smallinput.includes('thanks')) {
      reply (`Mention not *${pushname}* 😇. \nI am a bot after all.`);
    }      
...
case 'repo': case 'botrepo':
    ...
    reply(`*My Source Code:* https://github.com/ahmiaf/Miku-MD`)
    break
...
*/
 ...
 if (!m.quoted) return reply('Please mention a message dear!')
...
if (isBanChat) return reply(mess.bangc)
if (!isCreator) return replay(mess.botowner)
if (!args[0]) return replay(`Select add or delete (add to ban, delete to unban), For Example: Reply *${prefix}ban add* to the user you want to ban.`)
if (args[1]) {
...
case 'happymod': {
 ...
 if (!isBotAdmins) return replay(mess.botadmin)
 if (!isAdmins && !isCreator) return replay(mess.useradmin)
 if (!text) return replay('Pleases enter -setname <New Group Name>  to change this Group Name')
...
if (isBanChat) return reply(mess.bangc)
 ...
 if (!isBotAdmins) return replay(mess.botadmin)
 if (!isAdmins && !isCreator) return replay(mess.useradmin)
 if (!text) return replay('Please enter -setname <New Group Description>  to change this Group Description.')
 ...
 if (!/image/.test(mime)) return replay(`Send/Reply Image With Caption ${prefix + command} to change the Profile Picture of this group.`)
 if (/webp/.test(mime)) return replay(`Send/Reply Image With Caption ${prefix + command} to change the Profile Picture of this group.`)
    ...
    case 'group': case 'grup': {
     ...
     case 'tempo': {
        ...
        case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'tupai':
            ...
            } else reply(`Please mention any audio you want to modify _${prefix + command}_`)
            } catch (e) {
            reply(e)
            }
            break
...
try {
Miku.sendMessage(from, {video:{url:args[0]}, caption:"Success!", contextInfo:{externalAdReply:{
title:`${global.BotName}`,
...
case 'music': case 'play': case 'song': case 'ytplay': {
 ...
 if(!text) return Miku.sendMessage(from,{text:"Please enter song name to play!"},{quoted:m})
 let yts = require("yt-search")
...
case 'pinterest': case 'pin': {
    if (isBan) return reply(mess.banned)
    if (isBanChat) return reply(mess.bangc)
 if (!args.join(" ")) return reply("Please provide a search term!")
 try {
...
case 'swm': case 'take': case 'stickerwm': case 'steal':{
    if (isBan) return reply(mess.banned)
    if (isBanChat) return reply(mess.bangc)
if (!args.join(" ")) return reply(`Use command: -steal Miku|By: Ahmi`)
const swn = args.join(" ")
...
case 'handsomecheck':
    if (isBan) return reply(mess.banned)
    if (isBanChat) return reply(mess.bangc)
				if (!text) return replay(`Tag Someone, Example : ${prefix + command} @Ahmi`)
...
case 'charactercheck':
 ...
 case 'dare':
    ...
    if (isBanChat) return reply(mess.bangc)
         ...
         "Call your bestie now and send screenshot.",
         "Drop only emoji every time you type for 1 day.",
         "Say Who Wants To Be a Millionaire! to all the groups you have.",
         "Call your bestie and say I miss you.",
         "Sing the verse of the last song you played.",
         "Text your bestie, say hi (name), wants to call, just a moment. I miss you🥺👉🏼👈🏼",
         "Bang on the table until you get scolded for being noisy.",
         "Tell random people - I was just told I was your twin first, we separated, then I had plastic surgery. And this is the most ciyusss_ thing",
         "Mention bestie's name.",
         "Make 1 rhyme for the members!",
         "Send your whatsapp chat list.",
         "Chat random people with native language then sent screenshot here.",
         "Tell your own version of embarrassing things.",
         "Tag the person you hate.",
         "Pretending to be possessed, for example: possessed by dog, possessed by grasshoppers, possessed by refrigerator, etc.",
         "Change name to *I AM LEGEND* for 24 hours",
         "Shout *ma lut gaya ma lut gaya* in front of your house.",
         "Post boyfriend photo.",
         "Tell me your boyfriend type!",
         "Say *Please leave me alone.*",
         "Record your voice that read *Ma aa gaya*.",
         "Prank chat with your bestie and say *I love you, please come back.* without saying dare!",
         "Chat to contact on WhatsApp in the order according to your battery %, then tell him *I am lucky to have you!*",
         "Change the name to *I am a child of Superman* for 5 hours.",
         "Type in urdu 24 hours.",
         "Use random pic as dp for 3 days.",
         "Drop a song quote then tag a suitable member for that quote.",
         "Send voice note saying can i will call you?",
         "Screenshot recent call on whatsapp",
         "Say *YOU ARE SO BEAUTIFUL DON'T LIE* to all members!",
         "Poke to a group member, and say get lost.",
         "Act like a chicken in front of your parents.",
         "Pick up a random book and read one page out loud in voice and send it here.",
         ...
         "Make a funny video and put it on status for 5 mins",
         "Eat a raw piece of garlic.",
         "Show the last five people you texted and tell me here.",
         "Put your full name on status for 5 hours.",
         "Make a video without any filter and put it on your status for 5 hours.",
         "Call your bestie, *BLOODY FOOL.*",
         "Put your photo without filter on your status for 10 mins.",
         "Say I love you in voice note.🤣🤣",
         "Send a message to your bestie and say I like you.",
         "Call your bestie now and send screenshot here.",
         "Poke to one of the group member in personal chat and Say you ugly bustard.",
         "Say YOU ARE BEAUTIFUL/HANDSOME to one of person who is in top of your pinlist or the first person on your chatlist",
         "Send voice notes and say, can I will call you, if you are boy tag girl/if you are girl tag boy.",
         "Write I love you (random group member name, who is online) in personal chat, (if you are boy write girl name/if girl write boy name) take a snap of the pic and send it here.",
         "Use Maryum Aurangzab photo as dp for 3 days.",
         "Put your bestie photo on status with caption, this is my bestie.",
         "Change name to I AM FOOL for 5 hours.",
         "Chat to any contact in whatsapp and say I will be your bf/gf for 5 hours.",
         "Send voice note says *Bye Bye*",
         "Slap your face hardly send the sound of slap sound through voice note😂",
         "State your bestie type and send the photo here with caption, ugliest girl/boy in the world.",
         "Shout bravooooooooo and send here through voice note.",
         "Snap your face then send it here.",
         "Send your photo with a caption, i am garbage.",
         "Shout using harsh words and send it here through voice.",
         "Shout you help me...!!!! in front of your mom/dad.",
         "Change the name to I am idiot for 24 hours.",
         "Slap yourself firmly and send the sound of slap through voice note😂",
         "Say I love the bot owner Ahmi through voice note",
         "Send your bestie pic here.",
         "Make any challenge video and put it on status, you can delete it after 5 hours.",
         "Breakup with your best friend for 5 hours without telling him/her that its a dare.",
          "Tell one of your frind that you love him/her, without telling him/her that its a dare.",
          "Say I love Imran Khan through voice note.",
          "Write I am feeling sad and put it on status, you can delete it only after 5 hours.",
          "Write I am doomed and put it on status, you can delete only after 5 hours",
          "Kiss your mom or dad and say I love you😌.",
          "Put your father name on status for 5 hours.",
          "Send sweet words in any group, excepting this group, and send screenshot proof here."
     ]
...
case 'truth':
    ...
    if (isBanChat) return reply(mess.bangc)
                 ...
                 "If you can or if you want, which actor would you make friends with? (maybe different/same type)",
                 "Apa ketakutan terbesar kamu?",
                 "Have you ever liked someone and felt that person likes you too?",
                 "What is the name of your friend's bestie?",
                 "Have you ever stolen money from your father or mother?",
                 ...
                 "Have you ever rejected people? Any reason why?",
                 "Mention an incident that made you hurt that you still remember?", 
                 "What achievements have you got this year??",
                 "What's your worst habit at school?",
                 "What song do you sing most during shower?",
                 ...
                 "Do you like Baryani?",
                 "Have you ever fall from bed while sleeping?",
                 "What is the biggest mistake you have ever made?",
                 "Have you ever cheated in an exam?",
                 "What is the worst thing you have ever done?",
                 "When was the last time you cried?",
                 "Whom do you love the most among your parents?", 
                 "Do you sometimes put your thoughts in your nosetrilðŸ¤£?", 
                 "Who was your crush during the school days?",
                 "Tell honestly, do you like anyone in this group?",
                 "Have you ever liked anyone? how long?",
                 "What is your biggest fear?",
                 "Have you ever liked someone and felt that person likes you too?",
                 "What is the name of your exfriend?",
                 "Do you ever did you steal your mothers money or your fathers money?",
                 ...
                 "Do you still like the person you hate?",
                 "Whom do you like to play together with?",
                 "Have you ever stolen any thing in your life? the reason why?",
                 "Mention the incident that makes you hurt that you still remember?",
                 "What achievements have you got this year?",
                 "What was your worst habit at school?",
                 "Do you love the bot creator Ahmi?",
                 "Have you ever thought of taking revenge from your teacher?",
                 "Do you like current prime minister of your country?",
                 ...
                 "Do you play PUBG, if you then send your ID number?"
             ]
...
reply(mess.waiting)	
 ...
 var wbuttsssr = [
    {buttonId: `${prefix}waifu`, buttonText: {displayText: `>>`}, type: 1},
        ...
        caption: 'More than one waifu will definitely ruin your Life!',
        buttons: wbuttsssr,
        headerType: 4
         }     
